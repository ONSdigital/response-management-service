...
public class ActionDistributorImpl implements ActionDistributor {
   ...
   */
  @Inject
  public ActionDistributorImpl(PlatformTransactionManager transactionManager) {
    this.transactionTemplate = new TransactionTemplate(transactionManager);
  }

  /* (non-Javadoc)
   * @see uk.gov.ons.ctp.response.action.scheduled.impl.ActionDistributor#wakeUp()
   */
  @Override
   ...
   *         CaseFrameSvc
   */
  private ActionRequest prepareActionRequest(Action action) {
   ...
   * @param questionnaireDTO the Questionnaire representation from the CaseFrameSvc
   * @param addressDTO the Address representation from the CaseFrameSvc
   * @param caseEventDTOs the list of CaseEvent represenations from the CaseFrameSvc
   * @return the shiney new Action Request
   */
  private ActionRequest createActionRequest(Action action, CaseDTO caseDTO, QuestionnaireDTO questionnaireDTO, AddressDTO addressDTO, List<CaseEventDTO> caseEventDTOs) {
